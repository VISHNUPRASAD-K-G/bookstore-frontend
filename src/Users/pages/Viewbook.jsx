...
function Viewbook() {
  ...
  const makePayment = async () => {
    ...
    const stripe = await loadStripe('pk_test_51Rkge8Rv1NL0qMMiB001DQKmgV5i3A0CDBrUzbT9sguCly4m7mDmOy8UCAzlbwjy3Erphk2WpVeWsUubr0tLz2D500DDEqkyaI');
              ...
              <div className='py-5 relative'>
                ...
                <div className='md:flex w-full justify-end'>
                  <div className='flex justify-between'>
                    ...
                    <button type='button' onClick={makePayment} className='text-white bg-green-700 rounded px-6 py-4 md:ms-4 cursor-pointer hover:bg-green-800'>Buy $ {item.dprice}</button>
                  </div>
                </div>
